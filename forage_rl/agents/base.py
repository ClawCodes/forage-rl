...
class BaseAgent:
    ...
    def __init__(self, maze, beta: float = None):
        self.maze = maze
        self.beta = beta or DefaultParams.BETA
    ...
    def plot_q_values(self, max_time_to_display: int = 6, show: bool = True):
        ...
        max_time = min(max_time_to_display, self.q_table.shape[1])
        ...
        for i, action in enumerate([0, 1]):
            ...
            state_labels = ["Upper Patch", "Lower Patch"] if self.maze.num_states == 2 else [
